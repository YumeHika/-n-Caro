...
{
    public class Chess_Board_Manager_Battle
    {
        #region Properties
        ...
        private event EventHandler<ButtonClickEventBattle> playerMarked;
        public event EventHandler<ButtonClickEventBattle> Player_Marked
        {
            add
            {
                playerMarked += value;
        ...
        #region Initialize
        public Chess_Board_Manager_Battle(Panel chessBoard, TextBox Player_Name, PictureBox Mark)
        {
        ...
        void Btn_Click(object sender, EventArgs e)
        {
            ...
            if (playerMarked != null)
                playerMarked(this, new ButtonClickEventBattle(GetChessPoint(btn)));
    ...
    public class ButtonClickEventBattle : EventArgs
    {
        private Point clickedPoint;
        public Point ClickedPoint { get => clickedPoint; set => clickedPoint = value; }

        public ButtonClickEventBattle(Point point)
        {
